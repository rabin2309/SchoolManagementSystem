...
using SchoolManagementSystem.Models.ViewModels.ClassesViewModels;
...
namespace School_Management_System.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult UpdateClasses(int id)
        {
            ...
            var editClassesViewModel = new UpdateClassesViewModel
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UpdateClasses(UpdateClassesViewModel model)
        {
